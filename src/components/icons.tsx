...
export function XIcon({ className }: { className?: string | undefined }) {
  return (
...
export function MediumIcon({ className }: { className?: string | undefined }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export function SocialIcon({ name, className }: { name: string; className?: string | undefined }) {
  switch (name) {
    case "github":
