...
> = {
  ...
  "RoboPay — platform hardening & quality": {
    org: "Fabric Foundation",
    title: "RoboPay — تحصين المنصة وجودتها",
    summary:
      "سبعة طلبات دمج عامة لمستودع Fabric RoboPay: إخفاء بيانات الدفع الحساسة من السجلات، وتحصين CI الخاص بـ Go، وخط أساس جودة Python، ومُدقّق بنية سجل الملفات، وملفا روبوت Tier-1.",
    quote: null,
  },
  "Steinheim — luxury health brand engineering": {
    org: "ستينهايم",
    title: "ستينهايم — هندسة علامة صحية فاخرة",
    summary:
      "عشرون طلب دمج منجزة لعلامة صحية فاخرة حية: تطبيق PWA، ومساعد ذكاء اصطناعي ثنائي اللغة، ومحرك حملات موسمي، وأساس إتاحة، وتحصين أمني، وإتقان RTL العربي، ومخططات SEO.",
    quote: null,
  },
};
...
export const PROJECT_AR: Record<string, { tag: string; desc: string }> = {
  "Steinheim ERP & Invoicing": {
    tag: "مؤسسي",
    desc: "منصة عمليات داخلية متكاملة — الفوترة والمخزون وجرد المخزون وسجلات العملاء والتقارير وأداء المبيعات اليومي — إلى جانب المنتج الويب العام الحي، الذي شُحن عبر 20 طلب دمج.",
  },
  "RoboPay Spot Tier-1": {
    tag: "روبوتات · مدفوعات",
  ...
  "ai-agent-automation-platform": {
    tag: "الرائد · ذكاء اصطناعي",
    desc: "منصة تنسيق وكلاء محكومة: تخطيط، وكلاء متخصصون، بوابة موافقة بشرية، تنفيذ، تدقيق كامل، تقييم أوفلاين، إعادة محاولة وتماثل — بدون مفاتيح API، قابلة للاختبار بالكامل أوفلاين.",
  },
  "robot-sim-policy-lab": {
    tag: "روبوتات · محاكاة",
    desc: "تجارب روبوتات مدفوعة بالسياسات مع قياس تنفيذ المهام والتحقق الفيزيائي واختبار النقل بين المحاكيات MuJoCo وPyBullet.",
  },
  "RoboPay Go2 Tier-1": {
    tag: "روبوتات · Bounty PR",
    desc: "ملف محاكي Unitree Go2 Tier-1 ضمن برنامج RoboPay من Fabric — ملاحة مع العقبات مُعاد التحقق منها عبر MuJoCo + PyBullet، مقدم كـ PR عام.",
  },
  "production-systems-lab": {
    tag: "أنظمة · Go",
    desc: "لبنات Go جاهزة للإنتاج للأنظمة المالية والموزعة: التماثل، والحماية من إعادة التشغيل، وقواطع الدائرة، وإعادة المحاولة، ومصادقة HMAC، وتحديد المعدل، وتدقيق متسلسل بالتجزئة.",
  },
  "engineering-notes": {
    tag: "ملاحظات · غوص عميق",
    desc: "غوص معمّق يبدأ بالمشكلة — روبوتات مدفوعة بالسياسات، ومدفوعات مقاومة لإعادة التشغيل، وCI كأدلة، وتصميم واجهات آمنة. كل ادعاء ينتهي بأثر قابل للاختبار.",
  },
  "EslaM-X Sovereign Portfolio": {
    tag: "هذا الموقع",
    desc: "هذا الملف الاحترافي ثنائي اللغة (عربي/إنجليزي) المبني كنظام أدلة — كل ادعاء يفتح على ريبو عام أو PR أو معيار قياس، مع ميتا SSR عربية وإنجليزية لبطاقات المشاركة.",
  },
};
